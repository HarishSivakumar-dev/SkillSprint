...
INSERT INTO `admin_logs` VALUES (1,152,'2026-02-24');
...
INSERT INTO `attempts_table` VALUES (304,1,'PASSED',1,304,252),(353,1,'PASSED',1,353,252),(402,1,'FAILED',1,402,252),(452,1,'PASSED',2,452,252),(502,3,'PASSED',2,502,252),(552,1,'PASSED',2,552,252),(753,1,'PASSED',2,753,252);
...
INSERT INTO `attempts_table_seq` VALUES (851);
...
INSERT INTO `course_completion_status` VALUES (1,NULL,NULL,NULL),(2,NULL,NULL,NULL),(52,'Completed',1,252),(102,NULL,NULL,NULL),(152,NULL,NULL,NULL),(202,NULL,NULL,NULL),(252,NULL,NULL,NULL),(302,NULL,NULL,NULL),(303,NULL,NULL,NULL),(352,NULL,NULL,NULL),(402,'CompletedAndCertified',2,252);
...
INSERT INTO `course_completion_status_seq` VALUES (501);
...
INSERT INTO `enrollment_data` VALUES (1,'2026-02-03 14:01:46.666574',1,'ACTIVE',1,252),(2,'2026-02-03 14:35:06.306738',1,'Completed',2,252);
...
INSERT INTO `instructor_profile` VALUES (1,'I love building scalable backend systems and responsive frontend apps. Always learning new technologies and improving my skills.',4,100,'Ashwin','https://github.com/yourusername','Full Stack Developer',_binary '','2026-02-02','https://www.linkedin.com/in/yourprofile','harishss.ec24@bitsathy.ac.in','+911234567890','https://yourportfolio.com',0,0,'Passionate developer with 2 years of experience in web applications.',2,'0  Years0  Months22  Days',1,1,2,'https://yourwebsite.com',202,1);
...
INSERT INTO `instructor_skills` VALUES (1,1),(1,2),(1,3),(1,4),(1,5),(1,402),(1,403);
...
INSERT INTO `instructor_stat_update_seq` VALUES (651);
...
INSERT INTO `questions_seq` VALUES (1001);
...
INSERT INTO `quiz` VALUES (304,_binary '\0','week1Quiz',1,1,1,1),(353,_binary '\0','week2Quiz',2,1,1,2),(402,_binary '','finalQuiz',0,1,1,3),(452,_binary '\0','week1quiz',1,2,1,1),(502,_binary '\0','week2quiz',2,2,1,2),(552,_binary '\0','week2quiz2',2,2,1,3),(753,_binary '','course2FinalQuiz',2,2,1,4);
...
INSERT INTO `quiz_questions_seq` VALUES (651);
...
INSERT INTO `quiz_seq` VALUES (851);
...
CREATE TABLE `skill_approval` (
  ...
  KEY `FK881wc961qwitkvb029yr6gic9` (`instrutor_id`),
  CONSTRAINT `FK881wc961qwitkvb029yr6gic9` FOREIGN KEY (`instrutor_id`) REFERENCES `instructor_profile` (`id`),
...
INSERT INTO `skill_approval` VALUES (102,'Skill Verified','2026-02-24','Nginx','Approved',152,1),(103,'Skill Verified','2026-02-24','Docker','Approved',152,1),(104,'Applied skill doesnt have proper proof','2026-02-24','Kubernetes','Rejected',152,1),(105,'The instructor doesnt hold a devops certification','2026-02-24','AWS','Rejected',152,1);
...
INSERT INTO `skill_approval_seq` VALUES (201);
...
INSERT INTO `skills` VALUES (1,'Java'),(2,'Spring Boot'),(3,'HTML'),(4,'JavaScript'),(5,'SQL'),(402,'Nginx'),(403,'Docker');
...
INSERT INTO `skills_seq` VALUES (501);
...
INSERT INTO `streak_table` VALUES (1,0,1,NULL),(2,0,2,NULL),(52,0,52,NULL),(102,0,102,NULL),(152,0,152,NULL),(153,0,153,NULL),(202,0,202,NULL),(252,2,252,'2026-02-27');
...
INSERT INTO `super_admin_analytics` VALUES (1,'2026-02-27 14:20:00.034984',1,1,1,2,1,1);
...
INSERT INTO `user_profile_delta` VALUES (1,'Enrolled',1,_binary '',252),(2,'Enrolled',1,_binary '',252),(52,'QuizAttended',1,_binary '',252),(53,'QuizCleared',1,_binary '',252),(102,'QuizAttended',1,_binary '',252),(103,'QuizCleared',1,_binary '',252),(152,'QuizAttended',1,_binary '',252),(153,'Completed',1,_binary '',252),(202,'QuizAttended',1,_binary '',252),(203,'QuizCleared',1,_binary '',252),(252,'QuizAttended',1,_binary '',252),(352,'QuizCleared',1,_binary '',252),(402,'QuizCleared',1,_binary '',252),(403,'QuizCleared',1,_binary '',252),(452,'QuizAttended',1,_binary '',252),(453,'QuizCleared',1,_binary '',252),(502,'QuizAttended',1,_binary '',252),(503,'QuizCleared',1,_binary '',252),(504,'Certificates',1,_binary '',252),(505,'Completed',1,_binary '',252);
...
INSERT INTO `user_profile_delta_seq` VALUES (601);
...
INSERT INTO `user_registration` VALUES (52,'ACTIVE','harishss.2k07@gmail.com',_binary '','2026-02-01 22:49:30.781573','2026-02-26 09:57:08.474208','Harish','$2a$10$oMOoGZC9dNwp.rIEGeM6red/vzqeR5M7zKiCY28dENA/W88b1fEN.','Haris_07'),(102,'ACTIVE','harishsivakumar935@gmail.com',_binary '','2026-02-02 14:59:03.250247','2026-02-26 09:58:06.700175','Sathiya','$2a$10$CdaGSU8ex8uK8Fe9S/C/dOxOq3RhC75uC47B/Gfurs.kh8o0glE3u','Sathiya_83'),(152,'ACTIVE','harishsathiyasivakumar@gmail.com',_binary '','2026-02-02 15:26:59.712391','2026-02-26 09:58:20.056709','Sivakumar','$2a$10$4fuRkuzPaIOdrNQsHS.ITuVN/8Lk3X9X7.YtUiZ6NbYR2AHkFtRF6','Siva_k'),(202,'ACTIVE','harishss.ec24@bitsathy.ac.in',_binary '','2026-02-02 16:00:26.577634','2026-02-27 12:27:33.810054','Ashwin','$2a$10$FxW.DuZFutIXB8cTmX7S0uKX6WEKD1BC8zaU3Uc78dlIKOwyHr18C','ashwin_06'),(252,'ACTIVE','shivashanmugamk2506@gmail.com',_binary '','2026-02-03 11:43:35.547166','2026-02-27 14:21:42.613260','Shiva','$2a$10$dnYE0Ks/3.59yEo6LnNfgevrX0ynX/X/ArTbAJ9N2TIkKfTk77t8u','shiva_07');
...
-- Dump completed on 2026-02-27 15:46:33
